...
import { 
  MapPin, BedDouble, Bath, Home, Calendar, 
  IndianRupee, Building, Users, Heart, Share2, Phone, Mail, 
  Check, ChevronRight
} from 'lucide-react';
import CustomSquareFootage from '@/components/icons/SquareFootage';
              ...
              <Card className="mb-6">
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="flex flex-col items-center p-3 bg-gray-50 rounded-lg">
                      <CustomSquareFootage className="h-6 w-6 text-gray-500 mb-2" />
